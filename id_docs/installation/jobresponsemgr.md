...
```
{
      ...
      "profile": "UAT",
      "status": "Active",
      "servicecontext": "/api/v1/abls/jobresponsemgr",
      "internalurl": "http://jobresponsemgr-svc:7002",
      "externalurl": "https://intldsgn-dev.apps.id1.sde.sample.com",
      "securityon": false,
      "appid": {replace your appid},
      "appname": "jobresponsemgr-svc",
      "props": {
        "com.ibm.iw.service.name": {
          "value": "jobresponsemgr-svc",
          "secure": false
        },
        "com.ibm.iw.service.longDescription": {
          "value": "Job Response Manager",
          "secure": false
        },
