...
User manager – essential user group definition
...
5.  Repeat the following steps for `technologyOwnerGroupName`, `projectCoordinatorGroupName`, `macroOwnerGroupName`, and `macroDesignerGroupName`:
...
**Parent topic:**[Defining roles and groups](../../id_docs/installation/define_users_groups_r3.md)
